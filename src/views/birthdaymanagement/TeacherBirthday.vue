<template>
  <div class="content">
    ...
    <div class="hasagi" style="margin-top: 5px">
      ...
      <el-button
        v-if="checkPermission(['birthday_teacher_update'])"
        class="button-over"
        type="success"
...
import TeacherBirthdayService from "@/services/TeacherBirthdayService";
import ViewKidsBirthDay from "./ViewKidsBirthDay.vue";
import SendTeacherAppsend from "./SendTeacherAppsend.vue";
...
export default {
  ...
  methods: {
    ...
    searchTeacherbirthday() {
      ...
      this.textTable = "";
      TeacherBirthdayService.searchTeacherBirthdayNew(
        this.pageNumber,
        this.maxPageItem,
        this.dataSearch.date,
        this.dataSearch.week,
    ...
    handleSendNotifi(index, row) {
      ...
      this.$refs.SendTeacherAppsend.getDetailMethodSend(row.id);
      this.$refs.SendTeacherAppsend.getAllAppSend();
    },
    handleSendMultiNotifi() {
      ...
      if (list.length < 1) {
        ...
        this.showViewDetailSend = true;
        this.$refs.SendTeacherAppsend.getDetailMultiMethodSend(list);
        this.$refs.SendTeacherAppsend.getAllAppSend();
      }
    },
