<template>
  <el-dialog
    title="Chọn khoản công lương cho tạo mặc định"
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      EmployeeSalaryService.generateEmployeeSalaryDefault(this.dataInput)
        .then((resp) => {
          this.$message({
    ...
    getSalarySampleDefaultInitial(idEmployeeList) {
