  ...
  >
    ...
    >
      ...
      <el-form-item label="Chủ đề" prop="title">
        <el-input
          v-model="newCelebrateSample.title"
      ...
      <el-form-item label="Chọn ảnh">
        <el-image
          v-if="newCelebrateSample.urlPicture != null && showPicutreInitial"
          style="width: 150px; height: 150px; float: left; margin-right: 20px"
          :src="newCelebrateSample.urlPicture"
          fit="fill"
        ></el-image>
        <el-upload
          ...
          ref="upload"
        >
          <span v-if="newCelebrateSample.urlPicture != null">
    ...
    <span slot="footer" class="dialog-footer">
      <el-button
        type="danger"
        size="medium"
        @click="closeDialogByButton('newCelebrateSample')"
      >
    ...
    submitForm(fromData) {
      this.$refs[fromData].validate((valid) => {
        if (valid) {
          ...
          SchoolConfigService.updateCelebrateSample(formDatas)
            .then((response) => {
