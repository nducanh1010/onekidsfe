<template>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="danger" size="medium" @click="closeDialogByButton('birthdayUpdateSample')">
    ...
    submitForm(fromData) {
      this.$refs[fromData].validate((valid) => {
        if (valid) {
          ...
          SystemConfigService.updateBirthdaySample(formDatas)
            .then((response) => {
            ...
            .catch((err) => {
              this.$message({
                message: "Cập nhật lời chúc  thất bại",
                type: "error",
              });
              console.log(err);
            })
