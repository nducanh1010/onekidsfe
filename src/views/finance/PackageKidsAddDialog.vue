  ...
  >
    ...
    >
      ...
      <el-row :gutter="20" v-if="dataInput.attendance && dataInput.type == 'multiple'">
        ...
        <el-col
          :span="8"
          v-if="dataInput.attendance && dataInput.attendanceType != 'pickupLate'"
        >
...
export default {
  ...
  computed: {
    getAttendanceDetailList() {
      let detailList = [];
      // if (
      //   this.dataInput.attendanceType == "absentYes" ||
      //   this.dataInput.attendanceType == "absentNo"
      // ) {
      //   detailList = this.attendanceGoSchoolList;
      // } else if (this.dataInput.attendanceType == "goSchool") {
