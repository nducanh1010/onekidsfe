  ...
  >
    ...
    >
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="Trạng thái sử dụng" prop="usingStatus">
            <el-radio-group v-model="dataInput.usingStatus">
              <el-radio :label="true">Đang sử dụng</el-radio>
              <el-radio :label="false">Ngừng sử dụng</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["dataInput"].validate((valid) => {
        if (valid) {
          ...
          FnFeesService.updatePackage(this.dataInput)
            .then((resp) => {
              this.$message({
    ...
    getDataInitial(id) {
      FnFeesService.getPackageById(id)
        .then((resp) => {
