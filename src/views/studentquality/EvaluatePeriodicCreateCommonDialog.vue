...
export default {
  ...
  methods: {
     ...
     */
    submitForm(fromData) {
      let kidList = this.dataKidList;
      this.$confirm(
        "Bạn có chắc chắn muốn tạo nhận xét định kỳ chung cho " +
          kidList.length +
          " học sinh?",
        "Thông báo!",
        {
        ...
        EvaluateService.createEvaluatePeriodicMany(formDatas)
          .then((resp) => {
    ...
    getDataCommonInitial(kidList) {
      this.dataKidList = kidList;
    },
  },
};
</script>
