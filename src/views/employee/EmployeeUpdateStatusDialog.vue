<template>
  <div>
    <el-dialog
      :title="'Chuyển sang nghỉ làm: ' + fullName"
    ...
    >
      <el-form :model="dataInput" :rules="rules" ref="dataInput" label-width="140px">
        <el-form-item label="Chọn ngày nghỉ làm" prop="date">
          <el-date-picker
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      EmployeeDataService.updateEmployeeStatus(this.dataInput)
        .then((resp) => {
          this.$message({
    ...
    getStatusDataInitial(id, fullName) {
